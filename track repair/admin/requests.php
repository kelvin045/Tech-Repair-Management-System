...
<div class="col-sm-6 jumbotron mt-5">
    ...
    <form class="mx-4 my-4" action="" method="POST">
        ...
        <div class="form-group">
            <label for="reqinfo" class="font-weight-bold">Type of service</label>
            <input type="text" class="form-control" id="reqinfo" placeholder="i.e hardware or software" name="req_info" value="<?php if(isset($row['req_info'])){echo $row['req_info'];} ?>">
        </div>
        <div class="form-group">
            <label for="reqdesc" class="font-weight-bold">Description of the problem</label>
            <input type="text" class="form-control" id="reqdesc" placeholder="i.e damaged hard disk" name="req_desc"
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputcity" placeholder="i.e Nairobi" name="req_city"
                value="<?php if(isset($row['req_city'])){echo $row['req_city'];} ?>">
            </div>
            <div class="form-group col-md-4">
                <label for="inputstate" class="font-weight-bold">location</label>
                <input type="text" class="form-control" id="inputstate" placeholder="i.e Rongai" name="req_state" value="<?php if(isset($row['req_id'])){echo $row['req_id'];} ?>">
            </div>
            <div class="form-group col-md-2">
                <label for="inputzip" class="font-weight-bold">Number of services</label>
                <input type="number" class="form-control" id="inputzip" placeholder="i.e 2" name="req_zip" value="<?php if(isset($row['req_zip'])){echo $row['req_zip'];} ?>">
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputnumber" placeholder="i.e +254" name="req_number" onkeypress="isInputNumber(event)" value="<?php if(isset($row['req_mobile'])){echo $row['req_mobile'];} ?>">
            </div>
        </div> 
        <div class="form-row">
            <div class="form-group col-md-6">
