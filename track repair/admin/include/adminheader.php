...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top bg-danger p-2 shadow-lg">
        <a href="../index.php" class="navbar-brand col-sm-3 col-md-2 mr-0">Tech Repair</a>
    </nav>
    <!-- Side Bar -->
            ...
            <nav class="col-sm-2 bg-light sidebar py-5  d-print-none">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a href="requester.php" class="nav-link"><i class="fas fa-users mr-2"></i></i>Customers</a></li>
